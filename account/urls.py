...
urlpatterns = [
    path("login/cannyio/", views.cannyio_sso, name="cannyio_sso"),
    ...
    path("pro/purchases/cancel/", views.purchase_cancel, name="pro_purchase_cancel"),
    path("pro/purchases/payment/", views.purchase_payment, name="pro_purchase_payment"),
    path(
        "midtrans/<str:merchant_id>/payment_notification/",
        views.midtrans_payment_notification,
        name="midtrans_payment_notification",
    ),
