...
getPaths = () => {
  return {
    ...
    dist: {
      packageFolder: '',
      folder: 'dist-static',
      pages: 'dist-static/pages',
      all: 'dist-static/**/*',
      assets: 'dist-static/assets',
      img: 'dist-static/assets/img',
      css: 'dist-static/assets/css',
      scssSources: 'dist-static/scss',
      js: 'dist-static/assets/js',
      jsSources: 'dist-static/js',
      fonts: 'dist-static/assets/fonts',
      video: 'dist-static/assets/video',
      documentation: 'dist-static/documentation',
